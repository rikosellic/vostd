...
verus! {
    ...
    pub tracked struct Mapping {
        ...
        pub page_size: usize,
    /*  TODO: below are some "payload" fields that do not directly impact verification of the page table,
    ...
    pub open spec fn tree_to_path_refinement(
        ...
        forall |nr: usize|
            #[trigger]
            tv.inner.trace(PageTableTreePathModel::from_va((nr * CONST_PAGE_SIZE) as usize).view()) == pv[nr]
    }
    ...
    pub open spec fn tree_to_flat_refinement(
        ...
        forall |nr: usize|
            #[trigger]
            fv[nr] == as_mapping(tv.inner.trace(PageTableTreePathModel::from_va((nr * CONST_PAGE_SIZE) as usize)@))
    }
