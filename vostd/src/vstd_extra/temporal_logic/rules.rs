...
macro_rules! leads_to_trans_n {
    [$($tail:tt)*] => {
        ::vstd::prelude::verus_proof_macro_exprs!($crate::vstd_extra::temporal_logic::rules::leads_to_trans_n_internal!($($tail)*));
    };
}
...
macro_rules! temp_pred_and {
    [$($tail:tt)*] => {
        ::verus_builtin_macros::verus_proof_macro_exprs!($crate::vstd_extra::temporal_logic::rules::temp_pred_and_internal!($($tail)*))
    }
}
...
macro_rules! entails_and_n {
    [$($tail:tt)*] => {
        ::verus_builtin_macros::verus_proof_macro_exprs!($crate::vstd_extra::temporal_logic::rules::entails_and_n_internal!($($tail)*));
    };
}
...
macro_rules! entails_always_and_n {
    [$($tail:tt)*] => {
        ::vstd::prelude::verus_proof_macro_exprs!($crate::vstd_extra::temporal_logic::rules::entails_always_and_n_internal!($($tail)*));
    };
}
...
macro_rules! always_and_equality_n {
    [$($tail:tt)*] => {
        ::verus_builtin_macros::verus_proof_macro_exprs!($crate::vstd_extra::temporal_logic::rules::always_and_equality_n_internal!($($tail)*));
    };
}
...
macro_rules! always_lift_state_and_equality_n {
    [$($tail:tt)*] => {
        ::verus_builtin_macros::verus_proof_macro_exprs!($crate::vstd_extra::temporal_logic::rules::always_lift_state_and_equality_n_internal!($($tail)*));
    };
}
...
macro_rules! or_leads_to_combine_n {
    [$($tail:tt)*] => {
        ::verus_builtin_macros::verus_proof_macro_exprs!($crate::vstd_extra::temporal_logic::rules::or_leads_to_combine_n_internal!($($tail)*));
    };
}
...
macro_rules! leads_to_always_combine_n {
    [$($tail:tt)*] => {
        ::verus_builtin_macros::verus_proof_macro_exprs!($crate::vstd_extra::temporal_logic::rules::leads_to_always_combine_n_internal!($($tail)*));
    };
}
...
macro_rules! leads_to_always_combine_n_with_equality {
    [$($tail:tt)*] => {
        ::verus_builtin_macros::verus_proof_macro_exprs!($crate::vstd_extra::temporal_logic::rules::leads_to_always_combine_n_with_equality_internal!($($tail)*));
    };
}
...
macro_rules! combine_spec_entails_always_n {
    [$($tail:tt)*] => {
        ::verus_builtin_macros::verus_proof_macro_exprs!($crate::vstd_extra::temporal_logic::rules::combine_spec_entails_always_n_internal!($($tail)*))
    }
}
...
macro_rules! entails_always_lift_state_and_n {
    [$($tail:tt)*] => {
        ::vstd::prelude::verus_proof_macro_exprs!($crate::vstd_extra::temporal_logic::rules::entails_always_lift_state_and_n_internal!($($tail)*))
    };
}
...
macro_rules! invariant_n {
    [$($tail:tt)*] => {
        ::verus_builtin_macros::verus_proof_macro_exprs!($crate::vstd_extra::temporal_logic::rules::invariant_n_internal!($($tail)*))
    }
}
...
macro_rules! stable_and_n {
    [$($tail:tt)*] => {
        ::verus_builtin_macros::verus_proof_macro_exprs!($crate::vstd_extra::temporal_logic::rules::stable_and_n_internal!($($tail)*));
    };
}
...
macro_rules! stable_and_always_n {
    [$($tail:tt)*] => {
        ::verus_builtin_macros::verus_proof_macro_exprs!($crate::vstd_extra::temporal_logic::rules::stable_and_always_n_internal!($($tail)*));
    };
}
...
macro_rules! implies_new_invariant_n {
    [$($tail:tt)*] => {
        ::vstd::prelude::verus_proof_macro_exprs!($crate::vstd_extra::temporal_logic::rules::implies_new_invariant_n_internal!($($tail)*))
    };
}
...
macro_rules! always_lift_state_weaken_n {
    [$($tail:tt)*] => {
        ::vstd::prelude::verus_proof_macro_exprs!($crate::vstd_extra::temporal_logic::rules::always_lift_state_weaken_n_internal!($($tail)*))
    };
}
