...
use crate::aster_common::prelude::frame::{UFrame, MetaRegionOwners, MetaSlotOwner};
...
pub struct Cursor<'a, A: InAtomicMode>(pub crate::aster_common::prelude::page_table::Cursor<'a, UserPtConfig, A>);
...
pub struct CursorMut<'a, A: InAtomicMode> {
    pub pt_cursor: crate::aster_common::prelude::page_table::CursorMut<'a, UserPtConfig, A>,
