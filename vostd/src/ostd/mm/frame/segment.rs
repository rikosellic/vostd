...
use crate::ostd::mm::frame::inc_frame_ref_count;
...
impl<M: AnyFrameMeta> Segment<M> {
    ...
    > {
        ...
        proof {
            broadcast use crate::vstd_extra::map_extra::lemma_map_remove_keys_finite;
            broadcast use crate::vstd_extra::seq_extra::lemma_seq_to_set_map_contains;
    ...
    pub(crate) fn into_raw(self) -> Range<Paddr> {
        proof {
            broadcast use crate::vstd_extra::seq_extra::lemma_seq_to_set_map_contains;
            broadcast use crate::aster_common::prelude::frame::lemma_paddr_to_meta_biinjective;
